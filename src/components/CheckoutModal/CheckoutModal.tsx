...
export const CheckoutModal = () => {
  ...
  return (
    <>
      ...
      <div
        className={classNames(
          "fixed left-[50%] top-[50%] z-20 h-[40%] w-[90%] translate-x-[-50%] translate-y-[-50%] rounded-3xl border border-secondary bg-white opacity-0 shadow-xl shadow-zinc-500 transition-opacity duration-[1100ms] sm:w-[65%] xl:w-[45%]",
          { "opacity-100": isActive },
        )}
      >
        <div className="fixed left-[50%] top-[50%] flex w-[80%] translate-x-[-50%] translate-y-[-50%] flex-col items-center gap-y-4 text-center">
          ...
          <h1 className="text-2xl font-extrabold uppercase text-[#20AE5C]">
            Success
          </h1>
