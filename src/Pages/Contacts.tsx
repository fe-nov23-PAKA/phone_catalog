        ...
        <div className="flex w-full flex-col flex-wrap items-start justify-between gap-y-8 pb-8 sm:flex-row sm:justify-evenly xl:justify-evenly">
          ...
          <div className="flex h-full w-full flex-col items-center justify-start gap-y-4 rounded-lg border border-element-color bg-white p-6 shadow-lg shadow-zinc-400 dark:rounded-none dark:border-dark-surface2 dark:bg-dark-surface2 dark:shadow-zinc-700 sm:h-[328px] sm:w-[30%] xl:w-2/12 xl:shadow-2xl xl:shadow-zinc-600 xl:dark:shadow-zinc-700">
            <div>
              ...
              >
                <img
                  className="block w-[120px] rounded-lg object-contain transition-all hover:scale-[1.1] dark:rounded-none xl:h-[120px] xl:max-h-[160px] xl:max-w-[160px]"
                  src={a_duchenko}
                  alt="Anton"
                />
              </a>
          ...
          <div className="flex h-full w-full flex-col items-center justify-start gap-y-4 rounded-lg border border-element-color bg-white p-6 shadow-lg shadow-zinc-400 backdrop-grayscale-0 dark:rounded-none dark:border-dark-surface2 dark:bg-dark-surface2 dark:shadow-zinc-700 sm:h-[328px] sm:w-[30%] xl:w-2/12 xl:shadow-2xl xl:shadow-zinc-600 xl:dark:shadow-zinc-700">
            <div>
              <a
              ...
              >
                <img
                  className="block h-[120px] w-[120px] rounded-lg object-contain backdrop-grayscale transition-all hover:scale-[1.1] dark:rounded-none xl:max-h-[160px] xl:max-w-[160px]"
                  src={r_tkachuk}
                  alt="Rostyslav"
                />
              </a>
